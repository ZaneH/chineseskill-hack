...
@interface iPhone5MySentenceViewController : XXUnknownSuperclass <MJRefreshBaseViewDelegate, UITableViewDelegate, UITableViewDataSource, AVAudioRecorderDelegate, AVAudioPlayerDelegate> {
	bool _isRecording;
