...
@class NSString, AVAudioPlayer, FPPopoverController, Model_db_sentence, Model_db_sentence030, iPhonePlusWordPoperViewController, iPhonePlusLingoCheckBoxView, UIButton, iPhonePlusWordExplainPoperViewController, NSMutableArray, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhonePlusSentence3ViewController : iPhonePlusDataModelViewController <UIScrollViewDelegate, UIPopoverControllerDelegate, AVAudioPlayerDelegate, myDelegate> {
	UILabel* _todoLabel;
