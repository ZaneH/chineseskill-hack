...
@class CSSwitchView, UIButton, UILabel, NSString, UITableViewCell, UITableView;
@protocol myDelegate;

__attribute__((visibility("hidden")))
@interface SettingForBuyViewController : XXUnknownSuperclass <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverControllerDelegate, CSSwitchViewDelegate> {
	...
	UILabel* _rateThisAppLabel;
	UILabel* _logRegLabel;
	UILabel* _logInfoRegLabel;
	UILabel* _pytonecheckLabel;
	UIButton* _feedbackButton;
	UIButton* _moreappsButton;
	UIButton* _logRegButton;
...
@property(assign, nonatomic) __weak UILabel* logInfoRegLabel;
@property(assign, nonatomic) __weak UIButton* logRegButton;
@property(assign, nonatomic) __weak UILabel* logRegLabel;
...
@property(assign, nonatomic) __weak UILabel* rateThisAppLabel;
