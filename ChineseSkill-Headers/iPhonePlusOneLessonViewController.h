...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, UIActivityIndicatorView, iPhonePlusDataModelViewController, CSReportController, CSShareView, UIButton, UIImage, CAShapeLayer, NSDate, NSMutableArray, NSMutableDictionary, NSTimer, UILabel;

__attribute__((visibility("hidden")))
@interface iPhonePlusOneLessonViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
