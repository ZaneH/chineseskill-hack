...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, iPhone4UserSubscribeViewController, UIPopoverController, NSArray, UIButton, iPhone4NavView, NSMutableArray, NSMutableDictionary, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone4PlayBoardViewController : XXUnknownSuperclass <UIScrollViewDelegate, UIActionSheetDelegate, myDelegate> {
	BOOL _canRefresh;
