...
@protocol iPhone6SignupVCDelegate;

__attribute__((visibility("hidden")))
@interface iPhone6UserSignupViewController : XXUnknownSuperclass <UITextViewDelegate> {
	UILabel* _emailLabel;
	...
	id<iPhone6SignupVCDelegate> _delegate;
	UIButton* _backBtn;
}
...
@property(assign, nonatomic) __weak id<iPhone6SignupVCDelegate> delegate;
