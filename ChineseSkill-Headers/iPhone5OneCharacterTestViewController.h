...
@class UIButton, NSMutableArray, Model_db_character, UILabel, NSString, UIImageView, AVAudioPlayer, UIView, UIIPhone5MovingImage;

__attribute__((visibility("hidden")))
@interface iPhone5OneCharacterTestViewController : iPhone5DataModelViewController <AVAudioPlayerDelegate> {
	bool _ischecked;
	...
	UIIPhone5MovingImage* _curTouchButton;
...
@property(retain, nonatomic) UIIPhone5MovingImage* curTouchButton;
