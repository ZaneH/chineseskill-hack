...
@interface iPhone6MySentenceViewController : XXUnknownSuperclass <MJRefreshBaseViewDelegate, UITableViewDelegate, UITableViewDataSource, AVAudioRecorderDelegate, AVAudioPlayerDelegate> {
	bool _isRecording;
