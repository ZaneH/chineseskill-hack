...
@interface iPhone5AccountViewController : XXUnknownSuperclass <userLoginVCDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate> {
	BOOL isFullScreen;
