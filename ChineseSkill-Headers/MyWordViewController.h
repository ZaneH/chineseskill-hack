...
@class NSString, AVAudioPlayer, UIView, UITableView, NSURL, NSIndexPath, AVAudioRecorder, UIButton, NSMutableArray, NSTimer, Model_wordreview, UILabel;

__attribute__((visibility("hidden")))
@interface MyWordViewController : XXUnknownSuperclass <UITableViewDelegate, UITableViewDataSource, AVAudioRecorderDelegate, AVAudioPlayerDelegate> {
	bool _isRecording;
