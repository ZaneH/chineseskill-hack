...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, iPhone6DataModelViewController, UIActivityIndicatorView, CSReportController, CSShareView, UIButton, UIImage, NSMutableArray, NSMutableDictionary, NSTimer, UILabel;

__attribute__((visibility("hidden")))
@interface iPhone6CharacterTestViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
	BOOL _isChecked;
