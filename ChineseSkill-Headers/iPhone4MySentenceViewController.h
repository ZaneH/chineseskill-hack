...
@interface iPhone4MySentenceViewController : XXUnknownSuperclass <MJRefreshBaseViewDelegate, UITableViewDelegate, UITableViewDataSource, AVAudioRecorderDelegate, AVAudioPlayerDelegate> {
	bool _isRecording;
