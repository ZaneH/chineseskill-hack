...
@class NSString, FPPopoverController, UIView, iPhonePlusFourPYPoperViewController, iPhonePlusPinyinPoperViewController, UIButton, NSMutableDictionary, NSTimer, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhonePlusChinesePinyinViewController : XXUnknownSuperclass <FPPopoverControllerDelegate, UIScrollViewDelegate, UIActionSheetDelegate, myDelegate> {
	BOOL _alreadyPopup;
	FPPopoverController* _m_popoverController;
	iPhonePlusPinyinPoperViewController* _m_pinyinPoper;
	iPhonePlusFourPYPoperViewController* _m_fourPYPoper;
	UIView* _bgView;
	UILabel* _tLabel;
...
@property(retain, nonatomic) iPhonePlusFourPYPoperViewController* m_fourPYPoper;
@property(retain, nonatomic) iPhonePlusPinyinPoperViewController* m_pinyinPoper;
