...
@class CSSwitchView, UIButton, UILabel, NSString, iPhonePlusNavView, UITableViewCell, UITableView;
@protocol myDelegate;

__attribute__((visibility("hidden")))
@interface iPhonePlusSettingViewController : XXUnknownSuperclass <UIActionSheetDelegate, UINavigationControllerDelegate, UIPopoverControllerDelegate, CSSwitchViewDelegate> {
