...
@class UIImageView, NSString, AVAudioPlayer, FPPopoverController, iPhone4WordPoperViewController, UIWriteTranslationTextView, Model_db_sentence, Model_db_sentence020, UIButton, iPhone4WordExplainPoperViewController, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone4Sentence2ViewController : iPhone4DataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate, UITextViewDelegate, myDelegate> {
