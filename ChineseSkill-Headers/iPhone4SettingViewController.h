...
@class CSSwitchView, iPhone4NavView, UIButton, UILabel, NSString, UITableViewCell, UITableView;
@protocol myDelegate;

__attribute__((visibility("hidden")))
@interface iPhone4SettingViewController : XXUnknownSuperclass <UIActionSheetDelegate, UINavigationControllerDelegate, UIPopoverControllerDelegate, CSSwitchViewDelegate> {
