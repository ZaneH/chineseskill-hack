...
@interface iPhone6PlusSurvialDetailsViewController : XXUnknownSuperclass <UITableViewDelegate, UITableViewDataSource, AVAudioRecorderDelegate, AVAudioPlayerDelegate> {
	bool _isRecording;
...
- (id)tableViewCellWithReuseIdentifier:(id)reuseIdentifier atIndexPath:(id)indexPath;
- (void)updateImage;
