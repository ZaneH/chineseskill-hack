...
@class iPhone5WordExplainPoperViewController, NSString, AVAudioPlayer, FPPopoverController, CSScrollView, Model_db_sentence, UIMovingLabel, iPhone5WordPoperViewController, UIButton, Model_db_sentence040, NSMutableArray, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone5Sentence4ViewController : iPhone5DataModelViewController <CSScrollViewDelegate, UIScrollViewDelegate, UIPopoverControllerDelegate, AVAudioPlayerDelegate, myDelegate> {
	UILabel* _todoLabel;
