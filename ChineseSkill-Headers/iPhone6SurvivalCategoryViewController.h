...
@class UIButton, NSMutableArray, NSTimer, NSString, UIScrollView, UIView, UITableView;

__attribute__((visibility("hidden")))
@interface iPhone6SurvivalCategoryViewController : XXUnknownSuperclass <UITableViewDataSource, UITableViewDelegate> {
...
@property(retain, nonatomic) UIView* navTitle;
