...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, UIActivityIndicatorView, CSReportController, CSShareView, Model_db_lesson, UIButton, UIImage, NSMutableArray, DataModelViewController, NSMutableDictionary, NSTimer, UILabel;

__attribute__((visibility("hidden")))
@interface TestOutViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
	BOOL _isChecked;
