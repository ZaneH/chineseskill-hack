...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, UIActivityIndicatorView, CSReportController, CSShareView, Model_db_lesson, UIButton, UIImage, NSMutableArray, NSMutableDictionary, NSTimer, iPhone4DataModelViewController, UILabel;

__attribute__((visibility("hidden")))
@interface iPhone4TestOutViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
	BOOL _isChecked;
