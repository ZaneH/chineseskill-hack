...
@class Model_db_word060, Model_db_word, UIButton, NSMutableArray, NSTimer, UILabel, NSString, UIScrollView, AVAudioPlayer, iPhonePlusLingoCheckBoxView;

__attribute__((visibility("hidden")))
@interface iPhonePlusWordModel6ViewController : iPhonePlusDataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate> {
	UILabel* _todoLabel;
