...
@class NSTimer, Model_db_word050, UILabel, NSString, AVAudioPlayer, UIButton, iPhonePlusLingoCheckBoxView, Model_db_word;

__attribute__((visibility("hidden")))
@interface iPhonePlusWordModel5ViewController : iPhonePlusDataModelViewController {
	UILabel* _todoLabel;
	UILabel* _wordLabel;
