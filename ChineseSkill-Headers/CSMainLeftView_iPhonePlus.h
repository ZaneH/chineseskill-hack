...
@protocol CSMainLeftView_iPhonePlusDelegate;

__attribute__((visibility("hidden")))
@interface CSMainLeftView_iPhonePlus : XXUnknownSuperclass {
	BOOL _mainBtnLocked;
	BOOL _giftBtnLocked;
	BOOL _settingBtnLocked;
	BOOL _listenSpeakBtnLoced;
	id<CSMainLeftView_iPhonePlusDelegate> _delegate;
	UIButton* _mainBtn;
...
@property(assign, nonatomic) __weak id<CSMainLeftView_iPhonePlusDelegate> delegate;
