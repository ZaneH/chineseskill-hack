...
@class UIButton, NSMutableArray, UIiPhonePlusMovingImage, Model_db_character, UILabel, NSString, UIImageView, AVAudioPlayer, UIView;

__attribute__((visibility("hidden")))
@interface iPhonePlusOneCharacterTestViewController : iPhonePlusDataModelViewController <AVAudioPlayerDelegate> {
	bool _ischecked;
	...
	UIiPhonePlusMovingImage* _curTouchButton;
...
@property(retain, nonatomic) UIiPhonePlusMovingImage* curTouchButton;
