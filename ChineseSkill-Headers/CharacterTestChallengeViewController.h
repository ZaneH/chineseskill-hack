...
@interface CharacterTestChallengeViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
...
- (void)DirectQuitButtonClick:(id)click;
