...
@protocol CSMainLeftView_iPhone6Delegate;

__attribute__((visibility("hidden")))
@interface CSMainLeftView_iPhone6 : XXUnknownSuperclass {
	BOOL _mainBtnLocked;
	BOOL _giftBtnLocked;
	BOOL _settingBtnLocked;
	BOOL _listenSpeakBtnLoced;
	id<CSMainLeftView_iPhone6Delegate> _delegate;
	UIButton* _mainBtn;
...
@property(assign, nonatomic) __weak id<CSMainLeftView_iPhone6Delegate> delegate;
