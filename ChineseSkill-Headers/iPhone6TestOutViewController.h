...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, iPhone6DataModelViewController, UIActivityIndicatorView, CSReportController, CSShareView, Model_db_lesson, UIButton, UIImage, NSMutableArray, NSMutableDictionary, NSTimer, UILabel;

__attribute__((visibility("hidden")))
@interface iPhone6TestOutViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
	BOOL _isChecked;
