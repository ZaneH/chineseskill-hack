...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, iPhone4UserSubscribeViewController, UIPopoverController, NSArray, UIButton, NSMutableArray, NSMutableDictionary, iPhone6NavView, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone6PlayBoardViewController : XXUnknownSuperclass <UIScrollViewDelegate, UIActionSheetDelegate, myDelegate> {
	BOOL _canRefresh;
