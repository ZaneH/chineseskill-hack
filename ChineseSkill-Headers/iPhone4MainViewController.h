...
@class iPhone4ChinesePinyinViewController, iPhone4GiftBox, VerticallyAlignedLabel, UIButton, iPhone4PlayBoardViewController, NSMutableArray, CSShareView, NSMutableDictionary, iPhone4AchievementViewController, UILabel, UIScrollView, UIImageView, iPhone4SettingViewController, UIView, UIPopoverController, iPhone4UserSubscribeViewController, NSArray, NSString, iPhone4MainLeftView;
@protocol myDelegate;

__attribute__((visibility("hidden")))
@interface iPhone4MainViewController : XXUnknownSuperclass <UINavigationControllerDelegate, CSMainLeftView_iPhoneDelegate, CSShareSheetBtnClickedDelegate, UIActionSheetDelegate, usefulToolsViewDelegate, MBProgressHUDDelegate> {
	BOOL _isInView;
	BOOL _canMoveLeft;
	...
	iPhone4PlayBoardViewController* _midView;
	iPhone4MainLeftView* _leftView;
	iPhone4AchievementViewController* _rightVC;
	iPhone4GiftBox* _utView;
	UIImageView* _coverImageview;
	UIView* _currenMidView;
	UIButton* _cancelBtn;
	iPhone4SettingViewController* _settingVC;
	UIView* _preMidView;
	UIScrollView* _scrollView;
	CSShareView* _scv;
	iPhone4ChinesePinyinViewController* _pinYinVC;
	CGPoint _beginPoint;
	CGPoint _prePoint;
}
...
@property(retain, nonatomic) iPhone4GiftBox* utView;
- (void).cxx_destruct;
