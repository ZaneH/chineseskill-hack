...
@class Model_db_word060, Model_db_word, UIButton, NSMutableArray, iPhone5LingoCheckBoxView, NSTimer, UILabel, NSString, UIScrollView, AVAudioPlayer;

__attribute__((visibility("hidden")))
@interface iPhone5WordModel6ViewController : iPhone5DataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate> {
	UILabel* _todoLabel;
