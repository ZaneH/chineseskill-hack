...
@class Model_db_word060, Model_db_word, UIButton, NSMutableArray, NSTimer, UILabel, NSString, UIScrollView, iPhone6LingoCheckBoxView, AVAudioPlayer;

__attribute__((visibility("hidden")))
@interface iPhone6WordModel6ViewController : iPhone6DataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate> {
	UILabel* _todoLabel;
