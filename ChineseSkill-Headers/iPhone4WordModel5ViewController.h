...
@class NSTimer, Model_db_word050, UILabel, NSString, AVAudioPlayer, UIButton, iPhone4LingoCheckBoxView, Model_db_word;

__attribute__((visibility("hidden")))
@interface iPhone4WordModel5ViewController : iPhone4DataModelViewController {
	UILabel* _todoLabel;
	UILabel* _wordLabel;
