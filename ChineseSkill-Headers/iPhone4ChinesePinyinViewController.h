...
@class iPhone4FourPYPoperViewController, NSString, FPPopoverController, UIView, iPhone4PinyinPoperViewController, UIButton, NSMutableDictionary, NSTimer, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone4ChinesePinyinViewController : XXUnknownSuperclass <FPPopoverControllerDelegate, UIScrollViewDelegate, UIActionSheetDelegate, myDelegate> {
	BOOL _alreadyPopup;
	FPPopoverController* _m_popoverController;
	iPhone4PinyinPoperViewController* _m_pinyinPoper;
	iPhone4FourPYPoperViewController* _m_fourPYPoper;
	UIView* _bgView;
	UILabel* _tLabel;
...
@property(retain, nonatomic) iPhone4FourPYPoperViewController* m_fourPYPoper;
@property(retain, nonatomic) iPhone4PinyinPoperViewController* m_pinyinPoper;
