...
@class NSMutableDictionary, NSTimer, iPhone5LingoImageCheckBoxView, UILabel, NSString, Model_db_word010, Model_db_word;

__attribute__((visibility("hidden")))
@interface iPhone5WordModel1ViewController : iPhone5DataModelViewController <AVAudioPlayerDelegate> {
	UILabel* _todoLabel;
	UILabel* _translationLabel;
	iPhone5LingoImageCheckBoxView* _option1CheckBox;
	iPhone5LingoImageCheckBoxView* _option2CheckBox;
	iPhone5LingoImageCheckBoxView* _option3CheckBox;
	iPhone5LingoImageCheckBoxView* _option4CheckBox;
...
@property(retain, nonatomic) iPhone5LingoImageCheckBoxView* option1CheckBox;
@property(retain, nonatomic) iPhone5LingoImageCheckBoxView* option2CheckBox;
@property(retain, nonatomic) iPhone5LingoImageCheckBoxView* option3CheckBox;
@property(retain, nonatomic) iPhone5LingoImageCheckBoxView* option4CheckBox;
