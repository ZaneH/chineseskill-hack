...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, UIActivityIndicatorView, CSReportController, CSShareView, UIButton, UIImage, NSMutableArray, NSMutableDictionary, NSTimer, iPhone4DataModelViewController, UILabel;

__attribute__((visibility("hidden")))
@interface iPhone4CharacterTestViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
	BOOL _isChecked;
