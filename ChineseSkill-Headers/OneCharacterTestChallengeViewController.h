...
@class UIButton, NSMutableArray, Model_db_character, UILabel, NSString, UIImageView, AVAudioPlayer, UIMovingImage, UIView;

__attribute__((visibility("hidden")))
@interface OneCharacterTestChallengeViewController : DataModelViewController <AVAudioPlayerDelegate> {
	bool _ischecked;
...
@property(retain, nonatomic) UIMovingImage* curTouchButton;
