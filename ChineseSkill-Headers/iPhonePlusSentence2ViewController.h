...
@class UIImageView, NSString, AVAudioPlayer, FPPopoverController, UIWriteTranslationTextView, Model_db_sentence, Model_db_sentence020, iPhonePlusWordPoperViewController, UIButton, iPhonePlusWordExplainPoperViewController, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhonePlusSentence2ViewController : iPhonePlusDataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate, UITextViewDelegate, myDelegate> {
	...
	iPhonePlusWordPoperViewController* _wordExplainPoper;
	iPhonePlusWordExplainPoperViewController* _wordExplainDetailPoper;
...
@property(retain, nonatomic) iPhonePlusWordExplainPoperViewController* wordExplainDetailPoper;
@property(retain, nonatomic) iPhonePlusWordPoperViewController* wordExplainPoper;
