...
@class VerticallyAlignedLabel, NSString, UIIPhone5MySubscribeButton, UITableView, UIActivityIndicatorView, NSIndexPath, NSArray, NSSet, UIButton, UILabel;
@protocol myDelegate;

__attribute__((visibility("hidden")))
@interface iPhone5UserSubscribeViewController : XXUnknownSuperclass <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, UINavigationControllerDelegate, SKProductsRequestDelegate> {
	...
	UIIPhone5MySubscribeButton* _currentSubscribeButton;
	int _nUnitId;
}
...
@property(retain, nonatomic) UIIPhone5MySubscribeButton* currentSubscribeButton;
