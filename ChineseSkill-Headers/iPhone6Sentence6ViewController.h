...
@class UIImageView, AVAudioPlayer, NSString, UIWriteChineseSentenceTextView, Model_db_sentence, Model_db_sentence060, UIButton, UILabel;

__attribute__((visibility("hidden")))
@interface iPhone6Sentence6ViewController : iPhone6DataModelViewController <AVAudioPlayerDelegate, UITextViewDelegate> {
