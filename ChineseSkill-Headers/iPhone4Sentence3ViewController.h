...
@class NSString, AVAudioPlayer, FPPopoverController, iPhone4WordPoperViewController, Model_db_sentence, Model_db_sentence030, iPhone4LingoCheckBoxView, UIButton, iPhone4WordExplainPoperViewController, NSMutableArray, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone4Sentence3ViewController : iPhone4DataModelViewController <UIScrollViewDelegate, UIPopoverControllerDelegate, AVAudioPlayerDelegate, myDelegate> {
	UILabel* _todoLabel;
