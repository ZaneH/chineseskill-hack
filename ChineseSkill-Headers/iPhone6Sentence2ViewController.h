...
@class UIImageView, NSString, AVAudioPlayer, FPPopoverController, UIWriteTranslationTextView, Model_db_sentence, Model_db_sentence020, iPhone6WordExplainPoperViewController, UIButton, iPhone6WordPoperViewController, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone6Sentence2ViewController : iPhone6DataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate, UITextViewDelegate, myDelegate> {
