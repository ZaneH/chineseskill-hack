...
@class UIiPhone6MovingImage, UIButton, NSMutableArray, Model_db_character, UILabel, NSString, UIImageView, AVAudioPlayer, UIView;

__attribute__((visibility("hidden")))
@interface iPhone6OneCharacterTestViewController : iPhone6DataModelViewController <AVAudioPlayerDelegate> {
	bool _ischecked;
	...
	UIiPhone6MovingImage* _curTouchButton;
...
@property(retain, nonatomic) UIiPhone6MovingImage* curTouchButton;
