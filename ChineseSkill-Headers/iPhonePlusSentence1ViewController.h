...
@class iPhonePlusWordExplainPoperViewController, UIButton, iPhonePlusWordPoperViewController, FPPopoverController, Model_db_sentence, UILabel, NSString, UIScrollView, AVAudioPlayer, Model_db_sentence010, iPhonePlusLingoCheckBoxView;

__attribute__((visibility("hidden")))
@interface iPhonePlusSentence1ViewController : iPhonePlusDataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate, myDelegate> {
	UILabel* _todoLabel;
