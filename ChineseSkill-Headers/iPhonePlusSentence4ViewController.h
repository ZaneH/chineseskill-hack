...
@class NSString, AVAudioPlayer, FPPopoverController, CSScrollView, Model_db_sentence, UIMovingLabel, iPhonePlusWordPoperViewController, UIButton, Model_db_sentence040, iPhonePlusWordExplainPoperViewController, NSMutableArray, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhonePlusSentence4ViewController : iPhonePlusDataModelViewController <CSScrollViewDelegate, UIScrollViewDelegate, UIPopoverControllerDelegate, AVAudioPlayerDelegate, myDelegate> {
	UILabel* _todoLabel;
