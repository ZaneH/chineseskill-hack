...
@protocol iPhonePlusSignupVCDelegate;

__attribute__((visibility("hidden")))
@interface iPhonePlusUserSignupViewController : XXUnknownSuperclass <UITextViewDelegate> {
	UILabel* _emailLabel;
	...
	id<iPhonePlusSignupVCDelegate> _delegate;
	UIButton* _backBtn;
}
...
@property(assign, nonatomic) __weak id<iPhonePlusSignupVCDelegate> delegate;
