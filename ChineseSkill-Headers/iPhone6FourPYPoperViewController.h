...
@class Model_Pinyin, UIButton, NSTimer, NSURL, NSString, AVAudioPlayer, AVAudioRecorder, UIActivityIndicatorView;
@protocol myDelegate;

__attribute__((visibility("hidden")))
@interface iPhone6FourPYPoperViewController : XXUnknownSuperclass <AVAudioRecorderDelegate, AVAudioPlayerDelegate> {
	bool _isRecording;
