...
@class UIButton, FPPopoverController, iPhone5LingoCheckBoxView, iPhone5WordExplainPoperViewController, Model_db_sentence, UILabel, NSString, UIScrollView, AVAudioPlayer, Model_db_sentence010, iPhone5WordPoperViewController;

__attribute__((visibility("hidden")))
@interface iPhone5Sentence1ViewController : iPhone5DataModelViewController <UIPopoverControllerDelegate, AVAudioPlayerDelegate, myDelegate> {
	UILabel* _todoLabel;
