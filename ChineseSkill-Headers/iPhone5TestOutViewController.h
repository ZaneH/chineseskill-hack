...
@class VerticallyAlignedLabel, UIImageView, NSString, UIView, UIActivityIndicatorView, CSReportController, CSShareView, Model_db_lesson, UIButton, UIImage, iPhone5DataModelViewController, NSMutableArray, NSMutableDictionary, NSTimer, UILabel;

__attribute__((visibility("hidden")))
@interface iPhone5TestOutViewController : XXUnknownSuperclass <CSShareButtonDelegate, myDelegate, UIWebViewDelegate, UIActionSheetDelegate> {
	BOOL _isChecked;
	...
	Model_db_lesson* _m_TestOutLessonModel;
...
@property(retain, nonatomic) Model_db_lesson* m_TestOutLessonModel;
