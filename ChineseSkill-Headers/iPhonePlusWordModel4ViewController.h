...
@class UIImageView, AVAudioPlayer, NSString, UIWriteTranslationTextView, Model_db_word, UIButton, Model_db_word040, NSTimer, UILabel;

__attribute__((visibility("hidden")))
@interface iPhonePlusWordModel4ViewController : iPhonePlusDataModelViewController <UITextViewDelegate> {
