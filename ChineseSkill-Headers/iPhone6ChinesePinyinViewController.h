...
@class NSString, FPPopoverController, UIView, iPhone6PinyinPoperViewController, iPhone6FourPYPoperViewController, UIButton, NSMutableDictionary, NSTimer, UILabel, UIScrollView;

__attribute__((visibility("hidden")))
@interface iPhone6ChinesePinyinViewController : XXUnknownSuperclass <FPPopoverControllerDelegate, UIScrollViewDelegate, UIActionSheetDelegate, myDelegate> {
	BOOL _alreadyPopup;
	FPPopoverController* _m_popoverController;
	iPhone6PinyinPoperViewController* _m_pinyinPoper;
	iPhone6FourPYPoperViewController* _m_fourPYPoper;
	UIView* _bgView;
	UILabel* _tLabel;
...
@property(retain, nonatomic) iPhone6FourPYPoperViewController* m_fourPYPoper;
@property(retain, nonatomic) iPhone6PinyinPoperViewController* m_pinyinPoper;
