...
@class NSTimer, UILabel, NSString, UIImageView, UIButton, UIView;

__attribute__((visibility("hidden")))
@interface OneLevelUnitViewController : OneLevelUnitBaseViewController <UIActionSheetDelegate> {
	bool _isUnitBought;
	bool _isUnitUnLock;
